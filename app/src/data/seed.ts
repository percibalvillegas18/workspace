...
export const EMPLOYEES_SEED = [
  { id: 1, name: 'Sarah Ahmed', jobNumber: 'AIGH-0001', unitId: 13, position: 'SN', contactEmail: 'sarah.ahmed@aigh.sa', status: 'Active', hireDate: '2023-01-15' },
  { id: 2, name: 'Mohammed Al-Rashid', jobNumber: 'AIGH-0002', unitId: 21, position: 'HN', contactEmail: 'm.alrashid@aigh.sa', status: 'Active', hireDate: '2022-06-01' },
  { id: 3, name: 'Fatima Zahra', jobNumber: 'AIGH-0003', unitId: 15, position: 'CN', contactEmail: 'fatima.z@aigh.sa', status: 'Active', hireDate: '2023-03-10' },
  { id: 4, name: 'John Smith', jobNumber: 'AIGH-0004', unitId: 1, position: 'SN', contactEmail: 'john.smith@aigh.sa', status: 'Active', hireDate: '2024-01-20' },
  { id: 5, name: 'Aisha Khan', jobNumber: 'AIGH-0005', unitId: 13, position: 'PRACTITIONER', contactEmail: 'aisha.khan@aigh.sa', status: 'Active', hireDate: '2021-11-05' },
  { id: 6, name: 'Omar Hassan', jobNumber: 'AIGH-0006', unitId: 8, position: 'SN', contactEmail: 'omar.hassan@aigh.sa', status: 'Active', hireDate: '2023-07-12' },
  { id: 7, name: 'Layla Mahmoud', jobNumber: 'AIGH-0007', unitId: 25, position: 'MW', contactEmail: 'layla.m@aigh.sa', status: 'Active', hireDate: '2022-09-18' },
  { id: 8, name: 'David Lee', jobNumber: 'AIGH-0008', unitId: 21, position: 'NS', contactEmail: 'david.lee@aigh.sa', status: 'Active', hireDate: '2020-05-22' },
];
